...
describe("BusinessesMCP", () => {
  ...
  describe("create", () => {
    it("should create a business and then delete it", async () => {
  ...
  describe("getById", () => {
    it("should create, get by id, and delete a business", async () => {
      const payload: CreateBusinessDto = {
        name: generateTestBusinessName(),
        locationId,
        phone: "+1234567890",
      ...
      try {
        ...
        console.error(
          "Test failed: should create, get by id, and delete a business"
        );
        throw err;
      }
    });
